<div>
    <form wire:submit.prevent='addExpense' class=" ml-5 mt-9 mb-9 mr-7">
      <x-flash-messages />
        ...
        <button  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create new expense</button>
      </form>
</div>
